...
//
//     // 両方のタスクの完了を待つ
//     const [lowResult, highResult] = await Promise.all([lowPriorityTaskPromise, highPriorityTaskPromise]);
//
//     // ワーカーを停止
//     await worker.stop();
//
...
//     ];
//
//     const tasks3 = [tasks.delayedTask(100, 'Fast'), tasks.delayedTask(300, 'Medium'), tasks.delayedTask(500, 'Slow')];
//
//     // すべてのタスクを並行実行
